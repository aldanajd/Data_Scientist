...
classifier_model = load_model(r'C:\Users\aldan\OneDrive\Escritorio\Study Notes\2 - Python Machine Deep Learning\Deep Reinforcement Learning\saved_models\Model_1\Run-5')
